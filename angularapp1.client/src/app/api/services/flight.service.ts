...
export class FlightService extends BaseService {
   ...
   */
  flightGet$Plain$Response(params?: FlightGet$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<Flight>>> {
   ...
   * This method doesn't expect any request body.
   */
  flightGet$Plain(params?: FlightGet$Plain$Params, context?: HttpContext): Observable<Array<Flight>> {
   ...
   * This method doesn't expect any request body.
   */
  flightGet$Response(params?: FlightGet$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<Flight>>> {
   ...
   * This method doesn't expect any request body.
   */
  flightGet(params?: FlightGet$Params, context?: HttpContext): Observable<Array<Flight>> {
